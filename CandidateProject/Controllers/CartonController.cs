...
namespace CandidateProject.Controllers
{
    public class CartonController : Controller
    {
        ...
        {
            var cartons = db.Cartons.Include(c => c.CartonDetails)
        ...
        public ActionResult AddEquipment(int? id, string Error)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        public ActionResult RemoveEquipmentOnCarton([Bind(Include = "CartonId,EquipmentId")] RemoveEquipmentViewModel removeEquipmentViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (carton != null)
                {
                    ...
                    var detail = carton.CartonDetails.Where(e => e.EquipmentId == removeEquipmentViewModel.EquipmentId).FirstOrDefault();

                    db.CartonDetails.Remove(detail);
                    db.SaveChanges();
